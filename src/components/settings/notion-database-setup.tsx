			...
			<CardContent className="space-y-6">
				...
				<div className="rounded-lg border border-yellow-200 bg-yellow-50 p-4">
					...
					<p className="text-xs text-yellow-700">
						NotionでデータベースのURLを確認：
						<br />
						<code className="bg-yellow-100 px-1">
							https://notion.so/your-workspace/
							<strong>1234567890abcdef1234567890abcdef</strong>?v=...
						</code>
						<br />
						太字部分がデータベースIDです。
					</p>
				...
				<Button
					...
					disabled={
						isConfiguring ||
						!clothingDatabaseId.trim() ||
						!outfitsDatabaseId.trim()
					}
					className="w-full"
				>
				...
				<div className="rounded-lg border border-red-200 bg-red-50 p-4">
					...
					<ul className="space-y-1 text-red-700 text-xs">
						<li>
							• データベースにはNotionアプリケーションのアクセス権が必要です
						</li>
						<li>
							• プロパティ名とタイプは上記の仕様と完全に一致させてください
						</li>
