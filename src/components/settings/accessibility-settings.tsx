...
import { Keyboard, Volume2, Zap, Eye, Heart } from "lucide-react";
...
export function AccessibilitySettings() {
	...
	const accessibilityThemes = allThemes.filter(t => 
		['eye-friendly', 'high-contrast', 'deuteranopia', 'protanopia', 'tritanopia'].includes(t.id)
	);
			...
			<CardContent className="space-y-6">
					...
					<div className="space-y-3">
						...
						<div className="rounded-lg border border-theme-primary bg-theme-primary/10 p-3">
							<p className="text-theme-text-secondary text-xs">
								💡 <strong>ナビゲーションバーから簡単アクセス:</strong><br />
				...
				<div className="space-y-3">
					...
					<div className="grid grid-cols-1 gap-2 text-sm">
						<div className="flex justify-between items-center p-2 bg-theme-surface rounded">
							<span className="text-theme-text">アクセシビリティテーマ切り替え</span>
							<code className="bg-theme-border px-2 py-1 rounded text-xs">Ctrl+Shift+A</code>
						</div>
						<div className="flex justify-between items-center p-2 bg-theme-surface rounded">
							<span className="text-theme-text">ハイコントラスト</span>
							<code className="bg-theme-border px-2 py-1 rounded text-xs">Ctrl+Shift+H</code>
						</div>
						<div className="flex justify-between items-center p-2 bg-theme-surface rounded">
							<span className="text-theme-text">目に優しいテーマ</span>
							<code className="bg-theme-border px-2 py-1 rounded text-xs">Ctrl+Shift+E</code>
						</div>
						<div className="flex justify-between items-center p-2 bg-theme-surface rounded">
							<span className="text-theme-text">緊急ハイコントラスト</span>
							<code className="bg-theme-border px-2 py-1 rounded text-xs">Escape×3</code>
						</div>
						<div className="flex justify-between items-center p-2 bg-theme-surface rounded">
							<span className="text-theme-text">クイックセレクター</span>
							<code className="bg-theme-border px-2 py-1 rounded text-xs">Alt+T</code>
						</div>
					</div>
				</div>
				...
				<div className="rounded-lg border border-theme-warning bg-theme-warning/10 p-4">
					<h4 className="flex items-center gap-2 font-medium text-theme-warning text-sm mb-2">
						<Zap className="h-4 w-4" />
						緊急時のアクセス方法
					</h4>
					<ul className="space-y-1 text-theme-text-secondary text-xs">
						<li>• <strong>Escapeキー3回連続</strong>でハイコントラストモードに即切り替え</li>
						<li>• <strong>Alt+T</strong>でクイックテーマセレクターを開く</li>
						<li>• <strong>Ctrl+Shift+H</strong>で直接ハイコントラストモードに切り替え</li>
				...
				<div className="rounded-lg border border-theme-primary bg-theme-primary/10 p-4">
					<h4 className="flex items-center gap-2 font-medium text-theme-primary text-sm mb-2">
