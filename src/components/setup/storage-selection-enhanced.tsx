...
export function StorageSelectionEnhanced() {
	...
	const autoSetupMutation =
		api.notionSetup.setupWithDatabaseCreation.useMutation({
			onSuccess: (result) => {
				alert(
					`成功！ページ「${result.pageTitle}」にデータベースを作成しました`,
				);
				router.push("/");
			},
			onError: (error) => {
						...
						<div className="space-y-6">
							...
							{notionConfig.useAutoSetup ? (
								<div className="space-y-4">
									...
									<div>
										<Label htmlFor="notion-token-auto">
											Notion アクセストークン
										</Label>
										<Input
									...
									<div>
										...
										<Input
											...
											onChange={(e) =>
												handleNotionConfigChange("pageId", e.target.value)
											}
											className="mt-1"
										/>
										<p className="mt-1 text-purple-600 text-xs">
								...
								<div className="space-y-4">
									...
									<div>
										<Label htmlFor="notion-token-manual">
											Notion アクセストークン
										</Label>
										<Input
									...
									<div>
										<Label htmlFor="outfits-db-manual">
											コーデデータベースID
										</Label>
										<Input
						...
						<div className="rounded-lg border border-gray-200 bg-gray-50 p-4">
							...
							<div className="space-y-2 text-gray-700 text-sm">
								...
								<div className="flex items-start space-x-2">
									...
									<div>
										...
										データを自分で管理したい・Notionユーザー・柔軟性を重視する方におすすめ
									</div>
								</div>
							</div>
							...
							<div className="mt-4 rounded border border-blue-200 bg-blue-50 p-3">
								<p className="text-blue-800 text-xs">
									ℹ️
									後から設定画面で変更できますので、迷ったらPostgreSQLを選択してください。
								</p>
							</div>
						</div>
					)}
